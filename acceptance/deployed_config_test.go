...
var _ = Describe("deployed-config command", func() {
	var (
	...
	BeforeEach(func() {
		server = httptest.NewTLSServer(http.HandlerFunc(func(w http.ResponseWriter, req *http.Request) {
          ...
          "networks_and_azs": {
			...
			case "/api/v0/deployed/products/some-product-guid/jobs":
				w.Write([]byte(`{
					"jobs": [
					  {
							"name": "some-job",
			...
			case "/api/v0/deployed/products/some-product-guid/jobs/some-guid/resource_config":
				w.Write([]byte(`{
						"instances": 1,
						"instance_type": {
							"id": "automatic"
	...
	It("outputs a configuration template based on the deployed product", func() {
